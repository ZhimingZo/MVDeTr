...
from multiview_detector.utils.misc import * 
...
class SetCriterion_focal(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        """
        outputs_cp = {k: v for k, v in outputs.items()}

        # Retrieve the matching between the outputs of the last layer and the targets
        indices = self.matcher(outputs_cp, targets)
