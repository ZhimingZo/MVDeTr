...
class SetCriterion_ce(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        """
        outputs_copy = {k: v for k, v in outputs.items()}
        
        # Retrieve the matching between the outputs of the last layer and the targets
        indices = self.matcher(outputs_copy, targets)
...
def test():
    from multiview_detector.loss.pedtr.matcher import build_matcher
    matcher = build_matcher(args=None)
    print(matcher)
